    ...
    <div className="container">
      <div className="row">
          <div className="col-12">
              <h2 className="mt-4 mb-4">Bootstrap 5 Cards</h2>
          </div>
          ...
          <div className="col-md-6 col-lg-4">
              ...
              <div className="card-box">
                  <div className="card-thumbnail">
                      <img src="images/office-image-two.jpg" className="img-fluid" alt=""/>
                  </div>
          ...
          <div className="col-md-6 col-lg-4">
              ...
              <div className="card-box">
                  <div className="card-thumbnail">
                      <img src="images/office-image-three.jpg" className="img-fluid" alt=""/>
                  </div>
          ...
          <div className="col-md-6 col-lg-4">
              ...
              <div className="card-box">
                  <div className="card-thumbnail">
                      <img src="images/office-image-four.jpg" className="img-fluid" alt=""/>
                  </div>
          ...
          <div className="col-md-6 col-lg-4">
              ...
              <div className="card-box">
                  <div className="card-thumbnail">
                      <img src="images/office-image-five.jpg" className="img-fluid" alt=""/>
                  </div>
          ...
          <div className="col-md-6 col-lg-4">
              ...
              <div className="card-box">
                  <div className="card-thumbnail">
                      <img src="images/office-image-six.jpg" className="img-fluid" alt=""/>
                  </div>
                  <h3><a href="#" className="mt-2 text-danger">What is Lorem Ipsum?</a></h3>
                  <p className="text-secondary">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</p>
                  <a href="#" className="btn btn-sm btn-danger float-right">Read more</a>
